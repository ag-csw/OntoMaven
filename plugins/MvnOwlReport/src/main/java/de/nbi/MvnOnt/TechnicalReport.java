...
package de.nbi.MvnOnt;
	    ...
	    extends AbstractMavenReport
	{
		...
		private static ResourceBundle getBundle(Locale locale) {
			...
			return ResourceBundle.getBundle("owl-report", locale,TechnicalReport.class.getClassLoader());
		 }
		//-------------------------------------------------------------------------------------------------------
